...
export const IMPLEMENTED_TOOLS: ReadonlySet<string> = new Set([
  ...
  "line-numberer", "sentence-counter", "reading-time", "url-extractor", "fancy-text",
  "gmail-alias-variations", "email-syntax-advisor", "email-extractor", "email-pattern-builder",
  "mailto-link-builder", "email-size-estimator", "email-signature-builder",
  "spam-wording-advisor", "subject-line-advisor",
  // Crypto & security
  ...
  "regex-tester", "url-builder", "query-string-parser", "json-escape", "open-graph-generator", "twitter-card-generator",
